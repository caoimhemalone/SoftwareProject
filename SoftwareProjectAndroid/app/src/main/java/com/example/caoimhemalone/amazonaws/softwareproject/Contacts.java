...
public class Contacts extends AppCompatActivity {
    ...
    //https://www.dropbox.com/sh/1v26rj25mkf3916/AABPFnrtoCcipHvOKPkvMucba?dl=0
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        faBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i;
                i = new Intent(getApplicationContext(), NewContact.class);
                startActivity(i);
                finish();
            }
        });
        ...
        //add the tabs
        mTabLayout.addTab(mTabLayout.newTab().setText("Contact 1"));
        mTabLayout.addTab(mTabLayout.newTab().setText("Contact 2"));
        mTabLayout.addTab(mTabLayout.newTab().setText("Contact 3"));
        mTabLayout.addTab(mTabLayout.newTab().setText("Contact 4"));
        mTabLayout.addTab(mTabLayout.newTab().setText("Contact 5"));
